...
public class PTra10_04 {
	...
	public static void main(String[] args) {
		...
		for (int n =0;n<users.length;n++) {
			System.out.println(users[n].userId);
			System.out.println(users[n].userNm);
			System.out.println(users[n].mail);
			System.out.println(users[n].password);
		}
